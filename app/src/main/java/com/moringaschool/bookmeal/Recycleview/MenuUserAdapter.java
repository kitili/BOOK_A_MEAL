...
public class MenuUserAdapter extends RecyclerView.Adapter<MenuUserAdapter.MenuUserViewHolder> {
    ...
    public MenuUserAdapter(ArrayList<Menu> menuList, RecyclerViewClickListener listener){
    ...
    public class MenuUserViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener{
        ImageView imageFood;
    ...
    public MenuUserAdapter.MenuUserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MenuUserViewHolder(view);
    }
